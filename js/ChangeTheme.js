...
neon.addEventListener("click", function() {
    ...
    change1.style.color = `rgb(239, 241, 243)`
    change1.style.textShadow = "0 0 10px rgb(182,95,207), 0 0 40px rgb(182,95,207), 0 0 80px rgb(182,95,207)"

    change2.style.color = `rgb(239, 241, 243)`
    change2.style.textShadow = "0 0 10px rgb(182,95,207), 0 0 40px rgb(182,95,207), 0 0 80px rgb(182,95,207)"

    change3.style.color = `rgb(239, 241, 243)`
    change3.style.textShadow = "0 0 10px rgb(182,95,207), 0 0 40px rgb(182,95,207), 0 0 80px rgb(182,95,207)"
    ...
    pfp.style.boxShadow = `0 0 10px rgb(182,95,207), 0 0 40px rgb(182,95,207), 0 0 80px rgb(182,95,207)`
